...
var RegionForm = /** @class */ (function () {
    function RegionForm(option, ignoreWarning) {
        ...
        this.set = this.region.set;
        this.setBy = this.region.setBy;
        this.load = this.region.load;
        this.loadBy = this.region.loadBy;
        this.getProps = this.region.getProps;
        this.getValue = this.region.getValue;
        this.getLoading = this.region.getLoading;
        this.getError = this.region.getError;
        this.getFetchTime = this.region.getFetchTime;
        this.useProps = this.region.useProps;
        this.useValue = this.region.useValue;
        this.useLoading = this.region.useLoading;
        this.useError = this.region.useError;
        this.useFetchTime = this.region.useFetchTime;
