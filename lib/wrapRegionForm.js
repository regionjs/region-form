...
var wrapRegionForm = function wrapRegionForm(Region, adapter) {
  ...
  function (_Region) {
    ...
    function RegionForm() {
      ...
      _defineProperty(_assertThisInitialized(_this), "handlerFactory", function (key, selector, validate) {
      ...
      _defineProperty(_assertThisInitialized(_this), "bindWith", function (key, Component) {
        ...
        var handler = handlerFactory(key, selector, validate || defaultProps.validate); // TODO use useProps
